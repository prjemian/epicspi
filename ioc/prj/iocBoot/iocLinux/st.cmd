...
dbLoadDatabase("../../dbd/iocprjLinux.dbd")
iocprjLinux_registerRecordDeviceDriver(pdbbase)
...
dbLoadRecords("$(SSCAN)/sscanApp/Db/scan.db","P=prj:,MAXPTS1=8000,MAXPTS2=1000,MAXPTS3=10,MAXPTS4=10,MAXPTSH=8000")
...
dbLoadRecords("$(STD)/stdApp/Db/yySseq.db","P=prj:,S=Sseq1")
dbLoadRecords("$(STD)/stdApp/Db/yySseq.db","P=prj:,S=Sseq2")
dbLoadRecords("$(STD)/stdApp/Db/yySseq.db","P=prj:,S=Sseq3")
...
### user variables
dbLoadRecords("$(TOP)/prjApp/Db/user_pvs.db", "P=prj:,N=")

### PID_based feedback
dbLoadTemplate("fb_epid.substitutions")

### IOC-based ISO8601 timestamp
dbLoadRecords("$(TOP)/prjApp/Db/timestamp.db", "P=prj:,TS=timestamp")
# see also, from misc.db:   prj:datetime  prj:iso8601
